...
.PHONY: html help clean regenerate serve serve-global devserver publish publish_github ssh_upload rsync_upload dropbox_upload ftp_upload s3_upload cf_upload github
